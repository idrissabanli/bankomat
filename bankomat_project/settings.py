"""
Django settings for bankomat_project project.
...
SECRET_KEY = "sr0yaa@5%6i*lv^rivm53bzjq38em-2va8akp*#{SECRET_KEY}cdjm3n(m%o!"
...
MIDDLEWARE = [
    ...
    'bankomat_project.middleware.force_default_middleware.force_default_language_middleware',
...
WSGI_APPLICATION = 'bankomat_project.wsgi.application'
...
if PROD:  # For production docker use
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql_psycopg2',
            'NAME': 'bankomat_db_name',
            'USER': 'bankomat_db_user',
            'PASSWORD': 'sBGB57hCMwhEXSJZbhDTEcz',
            'HOST': 'localhost',
            'PORT': '5432',
        }
    }
